...
$string['referencemap_help'] = 'Lade eine Musterlösung als ViMi-Pad-Map im JSON-Export hoch. Wenn hinterlegt, wird die Map der Lernenden danach bewertet, wie viele der Referenzknoten und -relationen sie reproduziert. Leer lassen, um stattdessen gegen die Mindestanzahl an Knoten und Relationen zu bewerten.';
$string['referencemapincompatible'] = 'Die Musterlösung passt nicht zum gewählten Profil und den erlaubten Formen. Laden Sie eine passende Musterlösung hoch oder setzen Sie das Profil zurück.';
$string['referencemapinvalid'] = 'Die hochgeladene Datei ist kein gültiges JSON. Bitte lade eine als JSON exportierte ViMi-Pad-Map hoch.';
$string['responsesummary'] = 'Map mit {$a->nodes} Knoten und {$a->relations} Relation(en)';
$string['shape:ellipse'] = 'Ellipse';
$string['shape:rect'] = 'Rechteck';
$string['shape:roundrect'] = 'Abgerundetes Rechteck';
$string['shapesnotinprofile'] = 'Mindestens eine gewählte Form wird vom gewählten Diagrammprofil nicht unterstützt.';
