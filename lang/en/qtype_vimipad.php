...
$string['referencemapincompatible'] = 'The reference map does not match the chosen profile and allowed shapes. Upload a reference map that does, or change the profile back.';
...
$string['shape:roundrect'] = 'Rounded rectangle';
$string['shapesnotinprofile'] = 'One or more selected shapes are not supported by the chosen diagram profile.';
