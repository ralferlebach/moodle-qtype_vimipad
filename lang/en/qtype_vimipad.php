...
$string['referencemap_help'] = 'An optional author solution as a serialised ViMi Pad map (JSON). When set, the learner\'s map is scored on how many of the reference nodes and relations it reproduces. Leave empty to grade against the minimum node and relation counts instead.';
